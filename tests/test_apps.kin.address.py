...
class TestKinAddress(unittest.TestCase):
    ...
    def test_paths(self):
        ...
        correct_paths = [
            [44 | HARDENED, 2017 | HARDENED, 0 | HARDENED],
            [44 | HARDENED, 2017 | HARDENED, 3 | HARDENED],
            [44 | HARDENED, 2017 | HARDENED, 9 | HARDENED],
        ]
