...
class Zip143:
    def __init__(self):
        self.h_prevouts = HashWriter(blake2b(outlen=32, personal=b"KomodoPrevoutHash"))
        self.h_sequence = HashWriter(blake2b(outlen=32, personal=b"KomodoSequencHash"))
        self.h_outputs = HashWriter(blake2b(outlen=32, personal=b"KomodoOutputsHash"))
    ...
    def preimage_hash(
        ...
        h_preimage = HashWriter(
            blake2b(outlen=32, personal=b"KomodoSigHash\x19\x1b\xa8\x5b")
...
class Zip243(Zip143):
    ...
    def preimage_hash(
        ...
        h_preimage = HashWriter(
            blake2b(outlen=32, personal=b"KomodoSigHash\xbb\x09\xb8\x76")
