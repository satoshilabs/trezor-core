from trezor.messages.KinAddress import KinAddress
from trezor.messages.KinGetAddress import KinGetAddress

from apps.common import paths, seed
from apps.common.layout import address_n_to_str, show_address, show_qr
from apps.kin import helpers
...
async def get_address(ctx, msg: KinGetAddress, keychain):
    ...
    return KinAddress(address=address)
